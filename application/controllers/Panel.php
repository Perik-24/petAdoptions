...
class Panel extends CI_Controller {
	...
	public function index(){
		...
		$data['con_mascotas']	= $this->catalogos_m->con_mascotas("AC"); // Obtener mascotas activas
		$data['con_especies']	= $this->catalogos_m->con_especies(); // Obtener especies para el filtro
