...
class Catalogos_m extends CI_Model {
    ...
    public function con_generos ($tCodEstatus = false){
        $tQuery =   " SELECT * ".
                    " FROM vgeneros";
        $tQuery .=  ($tCodEstatus != false  ?   " WHERE tCodEstatus = '".$tCodEstatus."'" : "");
        $tQuery .=  " ORDER BY eCodGenero ASC ";
    ...
    public function con_especies ($tCodEstatus = false){
        $tQuery =   " SELECT * ".
                    " FROM vespecies";
        $tQuery .=  ($tCodEstatus != false  ?   " WHERE tCodEstatus = '".$tCodEstatus."'" : "");
        $tQuery .=  " ORDER BY eCodEspecie ASC ";
    ...
    public function con_mascotas ($tCodEstatus = false, $eCodMascota = false){
        $tQuery =   " SELECT * ".
                    " FROM vmascotas".
