...
<head>
	...
	<meta charset="UTF-8">
	<title>UTMA Plantilla Base</title>
	<meta name="application-name" content="Pnatilla Base para dècimos de la UTMA">
		...
		<header class="header">
			<div class="logo-container">
				<a href="<?= base_url(); ?>index.php/Panel" class="logo">
					<img src="<?= base_url(); ?>assets/images/header-logos.png" class="imgLogo" alt="UTMA" />
				</a>
